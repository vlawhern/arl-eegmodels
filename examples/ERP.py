"""
 ...
 Barachant's PyRiemann package, released under the BSD 3-clause. A copy of the
 BSD 3-clause license has been provided together with this software to comply 
 ...
 Riemannian geometric approaches with xDAWN spatial filtering using PyRiemann
 (code provided below). 
...
###############################################################################
# make prediction on test set. Due to very small sample sizes this can get
